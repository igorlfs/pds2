...
class LineProcessor {
  ...
  private:
    ...
    unsigned _numLinhasLidas;   /// O número de linhas lidas
    unsigned _numLinhasValidas; /// O número de linhas validas lidas
  ...
  public:
     ...
     */
    unsigned numeroDeLinhasLidas() const { return _numLinhasLidas; }
