...
// Os elementos da fila são std::string, e estão associados a uma dada
// prioridade. As prioridades são inteiros maiores ou iguais a zero. O item com
// a maior prioridade é o primeiro da fila. OBS: Os itens são armazenados na
// memória em uma lista encadeada.
